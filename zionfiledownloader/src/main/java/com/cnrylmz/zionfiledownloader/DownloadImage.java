...
public final class DownloadImage implements DownloadFile {
    ...
    public void start(final ZionDownloadListener downloadListener) {
        ...
        request.setDescription(context.getString(R.string.status_downloading_dw)).setTitle(context.getString(R.string.image_file_title_dw));
        request.setDestinationInExternalFilesDir(context, Environment.DIRECTORY_DOWNLOADS, fileName + ".jpg");
